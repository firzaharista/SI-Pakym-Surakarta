...
<body class="royal_loader">
    ...
    <div id="page">
                            ...
                            <div class="topbar-home2">
                                <div class="tb-contact tb-iconbox">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&to=<?php echo $c['email']; ?>"><i class="fa fa-envelope" aria-hidden="true"></i><span><i>Email</i> <?php echo $c['email']; ?></span></a></li>
                                ...
                                <div class="tb-social-lan language">
                                    ...
                                    <ul>
                                        <li><a href="?page=auth-login" data-placement=" bottom" class="" aria-hidden="true">Login Donatur</a></li>
                                        <li><a href="<?php echo $a['fb']; ?>" data-toggle="tooltip" data-placement="bottom" title="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li><a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&to=<?php echo $a['email']; ?>" data-toggle="tooltip" data-placement="bottom" title="email"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="navi-warp-home-2">
                                <a href=" " class="logo"><img src="images/logo/logo_pakym.png" height='150' width='180' class="img-responsive" alt="Image"></a>
                                    ...
                                    <ul class="navi-level-1 active-subcolor">
                                        ...
                                        <li><a href="#">Tentang Kami</a>
                                            <ul class="navi-level-2">
                                                ...
                                                <li><a href="?page=susunan-personalia"><span>Susunan Personalia</span></a></li>
                                                <li>
                                                    <a href="?page=jadwal-kegiatan"><span>Jadwal Kegiatan</span></a>
                                                </li>
                                        ...
                                        <li>
                                            ...
                                            <!-- <ul class="navi-level-2">
                                                <li><a href="single-shop.html">Panduan Pendaftaran</a></li>
                                                <li><a href="checkout.html">Syarat-syarat diterima</a></li>
                                            </ul> -->
                                        </li>
                                        <li>
        ...
        if ($page == "beranda") {
            ...
            if ($aksi == "") {
                include ".private/auth-login.php";
            }
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="subcribe-warp">
                            ...
                            <!-- <br>
                            <div>
                                <button><a href="?page=kontak" class="ot-btn btn-border-white-color">Hubungi Kami</a></button>
                            </div> -->
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="widget widget-footer widget-footer-text">
                            ...
                            <ul class="widget widget-footer widget-footer-social-1">
                                ...
                                <li><a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&to=<?php echo $a['email']; ?>"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
    ...
    <!-- sddwDSDWSAAS<script src="bower_components/chart.js/dist/Chart.min.js"></script> -->
