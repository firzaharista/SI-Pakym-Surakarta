...
<head>
	...
	<title>Amwal Shop Checkout</title>
	<!-- Bootstrap CSS -->
	...
	<!-- Favicons
			================================================== -->
	<link rel="shortcut icon" hre f="http://placehold.it/32x32/ccc.jpg">
</head>
	...
	<div id="page">
		...
		<section class="no-padding sh-company-history">
			<div class="sub-header ">
				...
				<ol class="breadcrumb">
					<li>
						<a href="#"><i class="fa fa-home"></i> DONASI SEKARANG </a>
					</li>
							...
							<div class="table-warp">
								<div class="table-responsive">
									<form class="form-contact-warp form-calc-ship cb-form" action="<?php $_SERVER['PHP_SELF'];?>" name='form' method="post" enctype="multipart/form-data">
										<div>
											<input class="form-control" value="" required="" title="" placeholder="Nama Lengkap" type="text">
										</div>
										<div>
											<input class="form-control" value="" required="" title="" placeholder="Email" type="text">
										</div>
										<div>
											<input class="form-control" value="" required="" title="" placeholder="Telepon" type="text">
										</div>
										<div>
											<textarea class="form-control" name="alamat" required="" placeholder="Alamat Lengkap" id="" cols="10" rows="4"></textarea>
										</div>
										<div>
											<input type="submit" class="btn btn" name="submit" value="Update Data">
										</div>
									</form>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6">
						<div class="widget widget-footer widget-footer-img">
							...
							<img src="http://placehold.it/242x157/ccc.jpg" class="img-responsive" alt="Image">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-md-12">
						<div class="copyright-warp cr-1">
							...
							<div class="copyright-text">
								<p>© 2016 Amwal - Powered By <span>Mohamed Arafa</span></p>
							</div>
						</div>
					</div>
				</div>
