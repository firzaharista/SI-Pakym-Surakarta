                                ...
                                <div class="table-responsive">
                                    <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                                        ...
                                        <tbody>
                                            <?php
                                            $no  = 1;
                                            $run = mysqli_query($conn, "SELECT * FROM user_donatur WHERE status='Donatur' order by waktu_add DESC");
                                            while ($data = mysqli_fetch_array($run)) {
                                                echo  "
                                                    <tr align='center'>
                                                        <td>$no</td>
                                                        <td>$data[username_donatur]</td>
                                                        <td>$data[nama]</td>
                                                        <td>$data[status]</td>
                                                        <td>
                                                            <a href='?page=detail-user-donatur&detail=$data[username_donatur_en]'><input type='button' class='btn btn-outline-success' value='Detail'></a>
