...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item">
        <span>DETAIL PENGGUNA DONATUR</span>
    </li>
    <!-- <li class="breadcrumb-item">
                ...
                <div class="element-wrapper">
                    ...
                    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
                        ...
                        <div style="padding: 0px 50px;">
                            ...
                            <?php
                            $detail = $_GET['detail'];
                            $sql    = "SELECT * FROM user_donatur WHERE username_donatur_en = '$detail'";
                            ...
                            <table style="margin-top: 0px; width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <a href="?page=user_donatur" style="padding: 5px 15px; background-color: #4B72FA; color: #fff; font-weight: bolder; font-size: 14px; display: inline-block; margin: 30px 0px; margin-right: 20px; text-decoration: none;">Kembali</a>
                                    </td>
                                </tr>
                            </table>
                        </div>