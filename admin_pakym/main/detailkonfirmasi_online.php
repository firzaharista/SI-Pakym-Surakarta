      ...
      <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item">
              <span>DETAIL KONFIRMASI DONASI</span>
          </li>
          <!-- <li class="breadcrumb-item">
          ...
          <div class="content-box">
              <div class="row">
                ...
                <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
                  ...
                  <img alt="" src="img/berita/debby.jpg" align="center" width="250" height="220" style="margin-left: 12%">
                  <div style="padding: 60px 70px;">
                    ...
                    <table style="margin-top: 40px; width: 100%;">
                      ...
                      <tr>
                        <td>
                          <a href="?page=konfirmasi" style="padding: 5px 15px; background-color: #4B72FA; color: #fff; font-weight: bolder; font-size: 14px; display: inline-block; margin: 30px 0px; margin-right: 20px; text-decoration: none;">Kembali</a>
                        </td>
                      </tr>
                    </table>
                </div>
