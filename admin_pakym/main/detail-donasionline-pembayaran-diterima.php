                      ...
                      <div class="col-sm-12">
                          <div class="element-wrapper">
                              ...
                              <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
                                  ...
                                  <?php
                                    $detail = $_GET['detail'];
                                    $sql = "SELECT * FROM donasi_online,bank_tujuan,waktu_donasionline WHERE status_donasi = 'Pembayaran Sudah Diterima' AND donasi_online.id_banktujuan = bank_tujuan.id_banktujuan AND waktu_donasionline.no_invoice = donasi_online.id_donasionline AND donasi_online.id_donasionline_en='$detail'";
                                    $run = mysqli_query($conn, $sql);
                                    $d = mysqli_fetch_array($run);
                                    ?>
                                  <h5 style="margin-left: 70px;">
                                      Detail Pembayaran Donasi Sudah Diterima
                                  </h5>
                                  <div style="padding: 30px 70px;">
                                      <table style="margin-top: 0px; width: 100%;">
                                          ...
                                          <tr>
                                              <td>
                                                  <a href="?page=donasionline-pembayaran-diterima" style="padding: 5px 15px; background-color: #4B72FA; color: #fff; font-weight: bolder; font-size: 14px; display: inline-block; margin: 30px 0px; margin-right: 20px; text-decoration: none;">Kembali</a>
                                              </td>
                                          </tr>
                                      </table>
                                  </div>
