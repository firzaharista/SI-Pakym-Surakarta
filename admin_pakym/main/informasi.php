                    ...
                    <div class="element-wrapper">
                        <div class="element-box">
                            <form id="formValidate" action="<?php $_SERVER['PHP_SELF']; ?>" name='form' method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="">Logo Panti Asuhan</label><br>
                                    <img src="../../images/logo/<?php echo $cetak[7]; ?>" width='265'>
                                    <?php echo $cetak[7]; ?> <br>
                                    <input class="form-control" data-error="Data harus diisi" placeholder="" required="required" type="file" name="filelogo">
                                    <div class="help-block form-text text-muted form-control-feedback">
                                        Logo untuk Website
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="">Favicon Panti Asuhan</label> <br>
                                    <img src="../../images/logo/<?php echo $cetak[8]; ?>" width='100'>
                                    <?php echo $cetak[8]; ?>
                                    <input class="form-control" data-error="Data harus diisi" placeholder="" required="required" type="file" name="filefavicon"                                 >
                                    <!-- <input class="form-control" data-error="Data harus diisi" placeholder="" required="required" type="file" name="filefavicon" value=' > -->
                                    <div class="help-block form-text text-muted form-control-feedback">
                            ...
                            $target = "../../images/logo/" . basename($_FILES['filelogo']['name']);
                            $target2 = "../../images/logo/" . basename($_FILES['filefavicon']['name']);
                            ...
                            if (isset($_POST['submit'])) {
                                if (move_uploaded_file($_FILES["filelogo"]["tmp_name"], $target) and move_uploaded_file($_FILES["filefavicon"]["tmp_name"], $target2)) {
                                    $update = ("UPDATE informasi SET namapanti='$namapanti',deskripsi='$deskripsi',judulweb='$judulweb',email='$email',telepon='$telp',alamat='$alamat',logo='$filelogo',favicon='$filefavicon',fb='$linkfb',footer='$footer' WHERE id_informasi=2");
                                    if (mysqli_query($conn, $update)) {
                                        ?>
                                        <script type="text/javascript">
                                            alert("Data telah berhasil diupdate");
                                            document.location = "?page=informasi";
                                        </script>
                                    <?php
                                    ...
                                    ?>
                                        <script type="text/javascript">
                                            alert("Data telah gagal diupdate");
                                            // document.location="?page=informasi";
                                        </script>
                                    <?php
